...
public class SmartPhones extends JFrame implements ActionListener{
	...
	SmartPhones(String s){
		...
		l2=new JLabel("Name");
		l3=new JLabel("Redmi Note 8 Pro");
		l4=new JLabel("Size");
		l5=new JLabel("6.53\"");
		l6=new JLabel("Battery");
		l7=new JLabel("4500mAh");
		l8=new JLabel("Price");
		l9=new JLabel("Rs 16,999");
		
		t2=new JLabel("Name");
		t3=new JLabel("Asus Rog Phone 2");
		t4=new JLabel("Size");
		t5=new JLabel("6.59\"");
		t6=new JLabel("Battery");
		t7=new JLabel("6000mAh");
		t8=new JLabel("Price");
		t9=new JLabel("Rs 37,999");
		...
		//main
		excl =new JLabel("The finest Smartphones in the market");
	...
	public void addAll() {
		...
		ImageIcon three=new ImageIcon("/home/gautham/Desktop/OopMaster/images.jpg");
		Phone3.setBounds(20,80,275,230);
		Phone3.setIcon(three);
		panel2.add(Phone3);
		
		ImageIcon four=new ImageIcon("/home/gautham/Desktop/OopMaster/rog.jpg");
