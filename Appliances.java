...
public class Appliances extends JFrame implements ActionListener{
	...
	Appliances(String s){
		...
		l2=new JLabel("Name");
		l3=new JLabel("Samsung Automatic");
		l4=new JLabel("Weight");
		l5=new JLabel("8 Kg");
		l6=new JLabel("Type");
		l7=new JLabel("Fully Automatic");
		l8=new JLabel("Price");
		l9=new JLabel("Rs 28,499");
		
		t2=new JLabel("Name");
		t3=new JLabel("Samsung Frost Free");
		t4=new JLabel("Capacity");
		t5=new JLabel("8 L");
		t6=new JLabel("Type");
		t7=new JLabel("Double drawer");
		t8=new JLabel("Price");
		t9=new JLabel("Rs 2,59,990");
		...
		//main
		excl =new JLabel("Home appliances from the most trusted brands.");
	...
	public void addAll() {
		...
		ImageIcon three=new ImageIcon("/home/gautham/Desktop/OopMaster/samsung-1.jpg");
		Phone3.setBounds(20,80,275,230);
		Phone3.setIcon(three);
		panel2.add(Phone3);
		
		ImageIcon four=new ImageIcon("/home/gautham/Desktop/OopMaster/whirl.jpg");
